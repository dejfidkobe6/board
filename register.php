...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .besix-logo{width:160px;height:auto;display:block;mix-blend-mode:screen}
  ...
  .invite-banner{background:rgba(160,120,20,0.12);border:1px solid rgba(160,120,20,0.3);border-radius:9px;padding:12px 14px;margin-bottom:20px;font-size:13px;color:rgba(210,185,70,0.9)}
